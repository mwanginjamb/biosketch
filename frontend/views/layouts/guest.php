...
<body class="bg-background text-on-background font-body-md clinical-gradient min-h-screen flex flex-col items-center justify-center">
<?php $this->beginBody(); ?>

<main class="w-full max-w-[1280px] px-margin-mobile md:px-margin-desktop py-xl flex flex-col items-center">
    <div class="w-full max-w-[440px] bg-surface-container-lowest border border-outline-variant p-lg md:p-xl shadow-sm transition-all duration-300">
        <?= $content ?>
    </div>
    ...
    <div class="mt-xl text-center max-w-[440px]">
        ...
        <p class="font-body-md text-body-md text-on-surface-variant opacity-70">
            Unauthorized access is strictly prohibited. Your session is monitored in compliance with Department of Biology security protocols.
        </p>
    </div>
</main>

<div class="fixed top-1/4 -left-20 w-80 h-80 bg-secondary-container opacity-10 blur-[100px] pointer-events-none rounded-full"></div>
<div class="fixed bottom-1/4 -right-20 w-64 h-64 bg-primary-container opacity-5 blur-[100px] pointer-events-none rounded-full"></div>

<footer class="w-full py-sm px-margin-desktop flex flex-col md:flex-row justify-between items-center mt-lg border-t border-outline-variant bg-surface-container-lowest">
